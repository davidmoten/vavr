...
public interface CheckedFunction<T, R> {
    ...
    /**
     * Creates a {@code CheckedFunction}.
     *
     * <pre>{@code
     * final CheckedFunction<String, String> f = CheckedFunction.of(String::toUpperCase);
     *
     * // = "HI!"
     * final String upper = f.apply("Hi!");
     * }</pre>
     *
     * @param methodReference (typically) a method reference, e.g. {@code Type::method}
     * @param <T> type the function's domain
     * @param <R> type the function's codomain
     * @return a new {@code CheckedFunction}
     */
